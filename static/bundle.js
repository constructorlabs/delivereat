...
var _OrderForm = __webpack_require__(/*! ./OrderForm */ "./src/components/OrderForm.js");
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.returnMenu = _this.returnMenu.bind(_this);
    _this.getOrder = _this.getOrder.bind(_this);
    _this.handleDelete = _this.handleDelete.bind(_this);
    _this.clearOrder = _this.clearOrder.bind(_this);
    _this.getOrderHistory = _this.getOrderHistory.bind(_this);
    _this.handleClearHistory = _this.handleClearHistory.bind(_this);
    _this.closeWasClicked = _this.closeWasClicked.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: "returnMenu",
    value: function returnMenu(result) {
      var resultArr = Object.keys(result).map(function (item) {
        return result[item];
      });
      this.setState({
        menu: resultArr
    ...
    value: function getOrder(order) {
      var things = Array.from(this.state.orders);
      var matchingOrder = things.find(function (currentOrder) {
      ...
      if (matchingOrder) {
        ...
        var ordersWithoutCurrentOrder = this.state.orders.filter(function (currentOrder) {
        ...
        this.setState({
          orders: [].concat(_toConsumableArray(this.state.orders), [order])
        });
      }
    }
  }, {
    ...
    value: function handleDelete(key) {
      this.setState(function (prevState) {
        return {
          orders: prevState.orders.filter(function (el) {
            return el.orderId != key;
          })
        };
      });
    }
    ...
    key: "getOrderHistory",
    value: function getOrderHistory(event) {
      var _this2 = this;

      event.preventDefault();
      fetch("/api/order", { method: "get" }).then(function (response) {
    ...
    key: "handleClearHistory",
    value: function handleClearHistory(key) {
      var _this3 = this;
      ...
      fetch("/api/order/" + key, { method: "delete" }).then(function (response) {
        return response.json();
      }).then(function (result) {
    ...
    key: "closeWasClicked",
    value: function closeWasClicked() {
      this.setState({
        closed: true
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "main" },
          Object.keys(this.state.orderhistory).length === 0 || this.state.closed === true ? null : _react2.default.createElement(_OrderHistory2.default, {
            orderhistory: this.state.orderhistory,
            handleClearHistory: this.handleClearHistory,
            closeWasClicked: this.closeWasClicked
          }),
          Object.keys(this.state.orders).length === 0 ? null : _react2.default.createElement(_OrderForm2.default, {
      ...
      return _react2.default.createElement(
        ...
        this.props.menu.map(function (item) {
          return _react2.default.createElement(_MenuItem2.default, {
            menu: item,
            key: item.id,
            getOrder: _this3.props.getOrder
          });
        })
      );
    }
...
var MenuItem = function (_React$Component) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function createOrder() {
      var orderId = this.props.menu.id;
      orderId = orderId + "." + this.state.orderId;
      this.state.orderId++;
      var price = this.props.menu.price * this.state.itemQuantity;
      var order = {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("input", { type: "text", size: "5", value: this.state.itemQuantity }),
            _react2.default.createElement("input", { onClick: this.handleClick, type: "button", value: "-" }),
            _react2.default.createElement("input", { onClick: this.handleClick, type: "button", value: "+" }),
            _react2.default.createElement(
              "button",
              { type: "submit" },
...
var _OrderFormItem = __webpack_require__(/*! ./OrderFormItem */ "./src/components/OrderFormItem.js");

var _OrderFormItem2 = _interopRequireDefault(_OrderFormItem);
...
var OrderForm = function (_React$Component) {
  ...
  function OrderForm(props) {
    ...
    _this.state = { subtotal: "", total: "" };

    _this.deleteFormItem = _this.deleteFormItem.bind(_this);
    _this.handleSubmit = _this.handleSubmit.bind(_this);
  ...
  _createClass(OrderForm, [{
    ...
    value: function componentDidMount() {
      ...
      var prices = Array.from(orders).map(function (el) {
        return el.price;
      });
      var totalPrice = prices.reduce(function (acc, item) {
        return acc + item;
      }, 0);
      var priceWithDelivery = totalPrice + 2.95;
      this.setState({
        subtotal: [].concat(_toConsumableArray(this.state.total), [totalPrice]),
        total: priceWithDelivery
      });
    }
  }, {
    key: "deleteFormItem",
    value: function deleteFormItem(key) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(this.props.orders).map(function (item) {
          return _react2.default.createElement(_OrderFormItem2.default, {
            order: _this2.props.orders[item],
            key: _this2.props.orders[item].orderId,
            deleteFormItem: _this2.deleteFormItem
          });
        }),
        _react2.default.createElement(
          "h6",
          { className: "orderform__deliverycharge" },
          " Subtotal: \xA3",
          totalPrice
        ),
        _react2.default.createElement(
          "p",
          { className: "orderform__deliverycharge" },
          "Delivery charge: \xA32.95"
        ),
        _react2.default.createElement(
          "div",
          { className: "orderform__total" },
          _react2.default.createElement(
            "p",
            null,
            "Total: \xA3",
...
/***/ "./src/components/OrderFormItem.js":
/*!*****************************************!*\
  !*** ./src/components/OrderFormItem.js ***!
  \*****************************************/
/*! no static exports found */
...
var OrderFormItem = function (_React$Component) {
  _inherits(OrderFormItem, _React$Component);

  function OrderFormItem(props) {
    _classCallCheck(this, OrderFormItem);

    var _this = _possibleConstructorReturn(this, (OrderFormItem.__proto__ || Object.getPrototypeOf(OrderFormItem)).call(this, props));
...
var _OrderHistoryItem = __webpack_require__(/*! ./OrderHistoryItem */ "./src/components/OrderHistoryItem.js");

var _OrderHistoryItem2 = _interopRequireDefault(_OrderHistoryItem);

var _OrderHistoryCloseButton = __webpack_require__(/*! ./OrderHistoryCloseButton */ "./src/components/OrderHistoryCloseButton.js");

var _OrderHistoryCloseButton2 = _interopRequireDefault(_OrderHistoryCloseButton);
...
var OrderHistory = function (_React$Component) {
  ...
  _createClass(OrderHistory, [{
    ...
    value: function render() {
      ...
      var key = Object.keys(this.props.orderhistory);
      return _react2.default.createElement(
        "div",
        { className: "form" },
        _react2.default.createElement(_OrderHistoryCloseButton2.default, { closeWasClicked: this.props.closeWasClicked }),
        _react2.default.createElement(
          "h3",
          null,
          "Order History"
        ),
        Object.keys(this.props.orderhistory).map(function (orderId) {
          return _react2.default.createElement(_OrderHistoryItem2.default, {
            orderhistory: _this2.props.orderhistory[orderId],
            id: key,
            orderId: orderId,
            deleteFormItem: _this2.deleteFormItem
...
/***/ "./src/components/OrderHistoryCloseButton.js":
/*!***************************************************!*\
  !*** ./src/components/OrderHistoryCloseButton.js ***!
  \***************************************************/
/*! no static exports found */
...
var OrderHistoryCloseButton = function (_React$Component) {
  _inherits(OrderHistoryCloseButton, _React$Component);

  function OrderHistoryCloseButton(props) {
    _classCallCheck(this, OrderHistoryCloseButton);

    var _this = _possibleConstructorReturn(this, (OrderHistoryCloseButton.__proto__ || Object.getPrototypeOf(OrderHistoryCloseButton)).call(this, props));
  ...
  _createClass(OrderHistoryCloseButton, [{
    key: "handleClick",
    value: function handleClick(event) {
      event.preventDefault();
  ...
  return OrderHistoryCloseButton;
}(_react2.default.Component);

exports.default = OrderHistoryCloseButton;

/***/ }),

/***/ "./src/components/OrderHistoryItem.js":
/*!********************************************!*\
  !*** ./src/components/OrderHistoryItem.js ***!
  \********************************************/
/*! no static exports found */
...
var OrderHistoryItem = function (_React$Component) {
  _inherits(OrderHistoryItem, _React$Component);

  function OrderHistoryItem(props) {
    _classCallCheck(this, OrderHistoryItem);

    var _this = _possibleConstructorReturn(this, (OrderHistoryItem.__proto__ || Object.getPrototypeOf(OrderHistoryItem)).call(this, props));

    _this.state = {};

    _this.handleDelete = _this.handleDelete.bind(_this);
    _this.handleReorder = _this.handleReorder.bind(_this);
    return _this;
  }

  _createClass(OrderHistoryItem, [{
    key: "handleDelete",
    ...
    key: "handleReorder",
    value: function handleReorder(event) {
      this.sendOrder();
    }
  }, {
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.orderhistory.map(function (orderItem) {
          return _react2.default.createElement(
            "p",
            null,
            orderItem.item,
...
exports.default = OrderHistoryItem;
