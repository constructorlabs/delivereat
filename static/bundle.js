...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.receiveNewQuantity = _this.receiveNewQuantity.bind(_this);
    _this.receiveWipeOrder = _this.receiveWipeOrder.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: "receiveWipeOrder",
    value: function receiveWipeOrder() {
      this.setState({
        currentOrder: {}
      });
    }
  }, {
    key: "receiveNewQuantity",
    value: function receiveNewQuantity(id, quantity) {
      var currentOrder = Object.assign({}, this.state.currentOrder, _defineProperty({}, id, +quantity));
...
var Basket = function (_React$Component) {
  ...
  function Basket() {
    ...
    _this.getBasket = _this.getBasket.bind(_this);
    return _this;
  }
  ...
  _createClass(Basket, [{
    ...
    key: "getBasket",
    value: function getBasket(total) {
      var _this2 = this;

      var deliveryCharge = total * 0.1;
      var fixedDeliveryCharge = deliveryCharge.toFixed(2);
      var orderTotal = total + deliveryCharge;
      var newOrderIds = Object.keys(this.props.currentOrder);
      var orderedItems = newOrderIds.map(function (orderId) {
        return _react2.default.createElement(
          "li",
          { key: orderId, className: "display__basket--listItem" },
          _this2.props.basketMenuItems[orderId].name
        );
      });
    ...
    value: function render() {
      ...
      var orderIds = Object.keys(this.props.currentOrder);
      var total = orderIds.reduce(function (acc, orderId) {
        return acc += _this3.props.currentOrder[orderId] * _this3.props.basketMenuItems[orderId].price;
      }, 0);
      return _react2.default.createElement(
        "div",
        { className: "display__basket" },
        _react2.default.createElement(
          "div",
          { className: "display__basket--box" },
  ...
  _createClass(Footer, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement("img", { src: "../../static/rabbit.png", className: "app__logo--footer" }),
        _react2.default.createElement(
          "p",
          null,
          "Powered by Waffles"
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement("img", { src: "../../static/rabbit.png", className: "app__logo" }),
        _react2.default.createElement(
          "h1",
          null,
          "DeliverRabbit"
...
var Item = function (_React$Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "li",
        { className: "display__menuItem" },
        _react2.default.createElement("hr", null),
        _react2.default.createElement(
          "div",
          { className: "display__left-col" },
          _react2.default.createElement(
            "h3",
            { className: "display__menuItem--title" },
            this.props.item.name
          ),
          _react2.default.createElement(
            "p",
            { className: "display__menuItem--subtitle" },
            "\xA3",
          ...
          _react2.default.createElement(
            "label",
            { className: "display__menutItem--label" },
            "Order",
        ...
        _react2.default.createElement(
          "div",
          { className: "display__right-col" },
          _react2.default.createElement("img", { src: this.props.item.img, className: "display__menuItem--img" })
        )
      );
    }
  }]);
...
var _Basket = __webpack_require__(/*! ./Basket */ "./src/components/Basket.js");
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "ul",
              { className: "display__menuItems" },
              this.props.menuItems.map(function (item) {
                return _react2.default.createElement(_Item2.default, {
                  item: item,
                  key: item.id,
                  receiveNewQuantity: _this2.props.receiveNewQuantity,
                  receiveInputValue: _this2.props.receiveInputValue,
                  quantity: _this2.props.currentOrder[item.id] || 0
                });
              })
            )
          )
