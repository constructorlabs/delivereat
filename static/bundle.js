...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.toggleLogo = _this.toggleLogo.bind(_this);
    return _this;
  }
...
var _Messages = __webpack_require__(/*! ./Messages */ "./src/components/Messages.js");
...
function HomePage() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "main",
      { className: "homepage__message-container" },
      _react2.default.createElement(
        "h2",
...
var _HomePage = __webpack_require__(/*! ./HomePage */ "./src/components/HomePage.js");

var _HomePage2 = _interopRequireDefault(_HomePage);

var _OldOrders = __webpack_require__(/*! ./OldOrders */ "./src/components/OldOrders.js");
...
var Main = function (_React$Component) {
  ...
  function Main() {
    ...
    _this.receiveUpdateOrder = _this.receiveUpdateOrder.bind(_this);
    _this.receiveReorderNew = _this.receiveReorderNew.bind(_this);
    return _this;
  }
  ...
  _createClass(Main, [{
    ...
    key: "reorderReceiver",
    value: function reorderReceiver(data) {
      this.setState({
        previousOrders: data
      });
    }
  }, {
    key: "receiveUpdateOrder",
    value: function receiveUpdateOrder(data) {
      this.setState({
        previousOrders: data
      });
    }
  }, {
    key: "receiveReorderNew",
    value: function receiveReorderNew(data) {
      this.setState({
        previousOrders: data
      });
    }
        ...
        _react2.default.createElement(_reactRouterDom.Route, {
          ...
          render: function render() {
            return _react2.default.createElement(_Menu2.default, {
              previousOrders: _this3.state.previousOrders,
              receiveUpdateOrder: _this3.receiveUpdateOrder,
              toggleLogo: _this3.props.toggleLogo
            });
          }
        }),
        _react2.default.createElement(_reactRouterDom.Route, {
          ...
          render: function render() {
            return _react2.default.createElement(_OldOrders2.default, {
              previousOrders: _this3.state.previousOrders,
              reorderReceiver: _this3.reorderReceiver,
              receiveReorderNew: _this3.receiveReorderNew
            });
          }
        })
      );
...
var Menu = function (_React$Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("/menu-items").then(function (response) {
        return response.json();
      }).then(function (data) {
        _this2.setState({
          menuItems: data
    ...
    key: "receiveOrder",
    value: function receiveOrder(item, quantity) {
      var tempOrder = {
        name: item.name,
        id: item.id,
        price: item.price,
      ...
      var totalSum = tempOrder.ownTotal + this.state.order.total;
      var newOrder = Object.assign({}, this.state.order, _defineProperty({}, item.id, tempOrder));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "display" },
        this.state.showOrder ? _react2.default.createElement(_Order2.default, {
          handleClose: this.handleClose,
          handleClick: this.handleClick,
          order: this.state.order
        }) : null,
        Object.values(this.state.menuItems).map(function (item) {
          return _react2.default.createElement(_MenuItem2.default, {
            key: item.id,
            item: item,
            receiveOrder: _this4.receiveOrder
          });
        })
      );
    }
...
function MenuItem(_ref) {
  var item = _ref.item,
      showOrder = _ref.showOrder,
      order = _ref.order,
      receiveOrder = _ref.receiveOrder;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "ul",
      { className: "display__menu-items" },
      _react2.default.createElement(
        "li",
        { key: item.id, className: "display__menu" },
        _react2.default.createElement(
          "h3",
          { className: "display__menu-title" },
          item.name
        ),
        _react2.default.createElement(
          "p",
        ...
        _react2.default.createElement("img", { className: "display__menu-images", src: item.img }),
        _react2.default.createElement(
          "label",
          null,
          "Quantity",
          _react2.default.createElement("input", { onChange: handleChange, type: "number", step: "1", min: "0" })
        ),
...
var Messages = function (_React$Component) {
  ...
  _createClass(Messages, [{
    ...
    key: "authorChange",
    value: function authorChange(event) {
      this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(this.state.messages).map(function (newMessage) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              "\" ",
              _this4.state.messages[newMessage].message,
              " \""
            ),
            _react2.default.createElement(
              "p",
              ...
              "-",
              _this4.state.messages[newMessage].person
            )
          );
        }),
        _react2.default.createElement(
          "form",
          { className: "messages__form", onSubmit: this.handleSubmit },
...
var _OldOrdersItem = __webpack_require__(/*! ./OldOrdersItem */ "./src/components/OldOrdersItem.js");

var _OldOrdersItem2 = _interopRequireDefault(_OldOrdersItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function OldOrders(_ref) {
  var previousOrders = _ref.previousOrders,
      reorderReceiver = _ref.reorderReceiver,
      receiveReorderNew = _ref.receiveReorderNew;
  ...
  return _react2.default.createElement(
    "div",
    { className: "display__oldOrders" },
    _react2.default.createElement(
      "h3",
      { className: "oldOrders__title" },
      "Previous ",
      _react2.default.createElement("br", null),
      "Orders"
    ),
    Object.keys(previousOrders).map(function (prevOrder) {
      return _react2.default.createElement(_OldOrdersItem2.default, {
        key: prevOrder.id,
        number: prevOrder,
        prevOrder: prevOrder,
...
/***/ "./src/components/OldOrdersItem.js":
/*!*****************************************!*\
  !*** ./src/components/OldOrdersItem.js ***!
  \*****************************************/
/*! no static exports found */
...
function OlderOrdersItem(_ref) {
  var number = _ref.number,
      prevOrder = _ref.prevOrder,
      previousOrders = _ref.previousOrders,
      handleDelete = _ref.handleDelete,
      handleReorder = _ref.handleReorder;
...
function Order(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "p",
        { className: "delivery__charge" },
        "*includes \xA32.40 delivery charge*"
      ),
      _react2.default.createElement(
        "button",
        { onClick: handleClick, className: "submit__order-button" },
        "Submit Order"
      ),
      _react2.default.createElement(
        "button",
