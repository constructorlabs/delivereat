...
var _BasketWidget = __webpack_require__(/*! ./basket/BasketWidget */ "./src/components/basket/BasketWidget.js");

var _BasketWidget2 = _interopRequireDefault(_BasketWidget);

var _Menu = __webpack_require__(/*! ./menu/Menu */ "./src/components/menu/Menu.js");

var _Menu2 = _interopRequireDefault(_Menu);

var _Basket = __webpack_require__(/*! ./basket/Basket */ "./src/components/basket/Basket.js");

var _Basket2 = _interopRequireDefault(_Basket);

var _OldOrders = __webpack_require__(/*! ./orders/OldOrders */ "./src/components/orders/OldOrders.js");

var _OldOrders2 = _interopRequireDefault(_OldOrders);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.ordersHandler = _this.ordersHandler.bind(_this);
    _this.oldOrdersHandler = _this.oldOrdersHandler.bind(_this);
    _this.checkOrderSentHandler = _this.checkOrderSentHandler.bind(_this);
    _this.receiverDeletedOrder = _this.receiverDeletedOrder.bind(_this);
    _this.receiverAddOrder = _this.receiverAddOrder.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'ordersHandler',
    value: function ordersHandler(dishId, quantity, price, action) {
      var _this3 = this;

      // Find if dish is already in orders and get position
      var dishPosition = Object.keys(this.state.currentOrders).find(function (order) {
        return _this3.state.currentOrders[order].dishId === dishId;
      });

      // If dish is already in orders update it
      if (dishPosition) {
        var currentOrders = Object.assign({}, this.state.currentOrders);
        if (quantity < 1) {
      ...
      // If dish is not already in orders add it
          ...
          var orderId = Object.keys(this.state.currentOrders).length > 0 ? parseInt(Object.keys(this.state.currentOrders).pop()) + 1 : 1;

          var newOrder = _defineProperty({}, orderId, {
            "dishId": dishId,
            "qty": quantity,
            "unitPrice": price,
      ...
      this.setState(function (currentState) {
        return {
          basket: Object.keys(currentState.currentOrders).reduce(function (acc, item) {
            return acc + parseInt(currentState.currentOrders[item].qty, 10);
          }, 0),
          orderAmount: function () {
            return action === "decrease" ? currentState.orderAmount - price : currentState.orderAmount + price;
          }()
        };
      });
    }
  }, {
    key: 'oldOrdersHandler',
    value: function oldOrdersHandler() {
      var _this4 = this;

      fetch('/api/orders?delivered=false').then(function (response) {
        return response.json();
      }).then(function (data) {
        _this4.setState({
          oldOrders: data
    ...
    key: 'receiverDeletedOrder',
    value: function receiverDeletedOrder(updatedOldOrders) {
      this.setState({
        oldOrders: updatedOldOrders
      });
    }
  }, {
    key: 'receiverAddOrder',
    value: function receiverAddOrder(updatedOldOrders) {
      this.setState({
        oldOrders: updatedOldOrders
      });
    }
  }, {
    key: 'checkOrderSentHandler',
    value: function checkOrderSentHandler() {
      this.setState({
        orderSent: true,
        currentOrders: {},
        orderAmount: 0,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Header2.default, { title: 'Delivereat' }),
        _react2.default.createElement(_BasketWidget2.default, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render() {
              return _react2.default.createElement(_Menu2.default, {
                receiver: _this5.ordersHandler,
                menu: _this5.state.menu,
                orders: _this5.state.currentOrders });
            }
          }),
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/menu', render: function render() {
              return _react2.default.createElement(_Menu2.default, {
                receiver: _this5.ordersHandler,
                menu: _this5.state.menu,
                orders: _this5.state.currentOrders });
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/basket', render: function render() {
              return _react2.default.createElement(_Basket2.default, {
                orderAmount: _this5.state.orderAmount,
                receiver: _this5.ordersHandler,
                currentOrders: _this5.state.currentOrders,
                oldOrders: _this5.oldOrdersHandler,
                menu: _this5.state.menu,
                deliveryPrice: _this5.state.deliveryPrice,
                orderSent: _this5.state.orderSent,
                orderSentReceiver: _this5.checkOrderSentHandler });
            }
          }),
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/old-orders', render: function render() {
              return _react2.default.createElement(_OldOrders2.default, {
                oldOrders: _this5.state.oldOrders,
                menu: _this5.state.menu,
                receiverDeletedOrder: _this5.receiverDeletedOrder,
                receiverAddOrder: _this5.receiverAddOrder });
            }
          })
        ),
    ...
    _createClass(Search, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { placeholder: "Search", type: "text", name: "search__input", id: "search__input", className: "search__input" }),
                _react2.default.createElement(
                    "button",
                    { className: "search__button", type: "submit" },
                    _react2.default.createElement(
                        "svg",
                        { version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "21", height: "21" },
                        _react2.default.createElement("rect", { id: "backgroundrect", width: "100%", height: "100%", x: "0", y: "0", fill: "none", stroke: "none" }),
                        _react2.default.createElement(
                            "g",
                            { className: "currentLayer" },
                            _react2.default.createElement("path", { d: "M20.809019088745117,18.27441120147705 l-5.086663722991943,-4.326348781585693 c-0.5261140465736389,-0.4731000065803528 -1.0884655714035034,-0.690524697303772 -1.5427757501602173,-0.6697217226028442 c1.2005332708358765,-1.4065498113632202 1.9259531497955322,-3.2311723232269287 1.9259531497955322,-5.225574016571045 c0,-4.447139739990234 -3.605626106262207,-8.052765846252441 -8.052765846252441,-8.052765846252441 s-8.052765846252441,3.605626106262207 -8.052765846252441,8.052765846252441 s3.605626106262207,8.052765846252441 8.052765846252441,8.052765846252441 c1.9944016933441162,0 3.8190243244171143,-0.7254199981689453 5.225574016571045,-1.9259531497955322 c-0.020802978426218033,0.45431020855903625 0.19662171602249146,1.0166617631912231 0.6697217226028442,1.5427757501602173 l4.326348781585693,5.086663722991943 c0.7408544421195984,0.8227242231369019 1.9507826566696167,0.8925149440765381 2.688952684402466,0.15434469282627106 s0.6690506339073181,-1.9480984210968018 -0.15434469282627106,-2.688952684402466 zM8.053439140319824,13.42194938659668 c-2.9647603034973145,0 -5.368510723114014,-2.4037506580352783 -5.368510723114014,-5.368510723114014 s2.4037506580352783,-5.368510723114014 5.368510723114014,-5.368510723114014 s5.368510723114014,2.4037506580352783 5.368510723114014,5.368510723114014 s-2.4037506580352783,5.368510723114014 -5.368510723114014,5.368510723114014 z", id: "svg_1" })
                        )
                    )
                )
            );
...
var _BasketProduct = __webpack_require__(/*! ./BasketProduct */ "./src/components/basket/BasketProduct.js");

var _BasketProduct2 = _interopRequireDefault(_BasketProduct);

var _BasketPriceDisplay = __webpack_require__(/*! ./BasketPriceDisplay */ "./src/components/basket/BasketPriceDisplay.js");

var _BasketPriceDisplay2 = _interopRequireDefault(_BasketPriceDisplay);

var _BasketEmptyMessage = __webpack_require__(/*! ./BasketEmptyMessage */ "./src/components/basket/BasketEmptyMessage.js");

var _BasketEmptyMessage2 = _interopRequireDefault(_BasketEmptyMessage);

var _SubNavigation = __webpack_require__(/*! ../navs/SubNavigation */ "./src/components/navs/SubNavigation.js");

var _SubNavigation2 = _interopRequireDefault(_SubNavigation);

var _BasketCheckoutButton = __webpack_require__(/*! ./BasketCheckoutButton */ "./src/components/basket/BasketCheckoutButton.js");

var _BasketCheckoutButton2 = _interopRequireDefault(_BasketCheckoutButton);

var _BasketOrderSent = __webpack_require__(/*! ./BasketOrderSent */ "./src/components/basket/BasketOrderSent.js");

var _BasketOrderSent2 = _interopRequireDefault(_BasketOrderSent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function Basket(props) {
    var totalAmount = props.orderAmount + props.deliveryPrice;
    var deliveryPrice = props.deliveryPrice;
    ...
    function checkoutHandler(order) {
        ...
        var orderDate = date.toDateString() + ", " + date.getHours() + ":" + minutes + ":" + seconds;
        var orderNew = Object.assign({}, { products: [order] }, { orderDate: orderDate }, { delivered: false }, { deliveryPrice: deliveryPrice }, { totalAmount: totalAmount });
    ...
    return _react2.default.createElement(
        'div',
        { className: 'menu menu-wrapper' },
        _react2.default.createElement(_SubNavigation2.default, {
        ...
        _react2.default.createElement(
            'div',
            { id: 'menu-container', className: 'menu-container' },
            _react2.default.createElement(_BasketOrderSent2.default, { orderSent: props.orderSent }),
            _react2.default.createElement(_BasketEmptyMessage2.default, { orders: props.currentOrders }),
            Object.keys(props.currentOrders).map(function (orderKey) {
                var _props$currentOrders$ = props.currentOrders[orderKey],
                    dishId = _props$currentOrders$.dishId,
                    price = _props$currentOrders$.price,
                    qty = _props$currentOrders$.qty;

                return _react2.default.createElement(_BasketProduct2.default, {
                    key: dishId,
                    dishId: dishId,
                    price: price,
                    qty: qty,
            ...
            _react2.default.createElement(_BasketPriceDisplay2.default, {
                totalAmount: totalAmount,
                orders: props.currentOrders,
                orderAmount: props.orderAmount,
                deliveryPrice: props.deliveryPrice }),
            _react2.default.createElement(_BasketCheckoutButton2.default, {
...
/***/ "./src/components/basket/BasketCheckoutButton.js":
/*!*******************************************************!*\
  !*** ./src/components/basket/BasketCheckoutButton.js ***!
  \*******************************************************/
/*! no static exports found */
...
function BasketCheckoutButton(props) {
    return _react2.default.createElement(
        'div',
        { className: "basket__checkout-button " + (Object.keys(props.orders).length > 0 ? '' : 'hidden'),
            onClick: function onClick() {
                return props.receiverCheckOutHandler(props.orders);
            },
...
exports.default = BasketCheckoutButton;

/***/ }),

/***/ "./src/components/basket/BasketEmptyMessage.js":
/*!*****************************************************!*\
  !*** ./src/components/basket/BasketEmptyMessage.js ***!
  \*****************************************************/
/*! no static exports found */
...
exports.default = BasketEmpty;

/***/ }),

/***/ "./src/components/basket/BasketOrderSent.js":
/*!**************************************************!*\
  !*** ./src/components/basket/BasketOrderSent.js ***!
  \**************************************************/
/*! no static exports found */
...
function BasketOrderSent(props) {
    return _react2.default.createElement(
        'div',
        { className: "basket-order__sent " + (props.orderSent === true ? '' : 'hidden') },
        'Order placed.'
    );
}

exports.default = BasketOrderSent;

/***/ }),

/***/ "./src/components/basket/BasketPriceDisplay.js":
/*!*****************************************************!*\
  !*** ./src/components/basket/BasketPriceDisplay.js ***!
  \*****************************************************/
/*! no static exports found */
...
function BasketPriceDisplay(props) {
    return _react2.default.createElement(
        'div',
        { className: "basket__checkout-button_wrapper " + (Object.keys(props.orders).length > 0 ? '' : 'hidden') },
        _react2.default.createElement(
            'div',
            null,
            'Order: ',
            _react2.default.createElement(
                'strong',
                null,
                props.orderAmount.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
            )
        ),
        _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
                'strong',
                null,
                props.deliveryPrice.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
            )
        ),
        _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
                'strong',
                null,
                props.totalAmount.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
            )
        )
    );
}

exports.default = BasketPriceDisplay;

/***/ }),

/***/ "./src/components/basket/BasketProduct.js":
/*!************************************************!*\
  !*** ./src/components/basket/BasketProduct.js ***!
  \************************************************/
/*! no static exports found */
...
function BasketProduct(props) {
    ...
    var order = {};
    Object.keys(props.menu).forEach(function (orderKey) {
    ...
    return _react2.default.createElement(
        "div",
        { className: "dish" },
        _react2.default.createElement("div", { className: "dish__image", style: { backgroundImage: "url(" + order.image + ")" } }),
        _react2.default.createElement(
            "div",
            { className: "dish__details" },
            _react2.default.createElement(
                "h2",
                { className: "dish__heading" },
                order.name
            ),
            _react2.default.createElement(
                "p",
                { className: "dish__ingredients" },
                order.ingredients,
                "."
            ),
            _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                { onClick: function onClick(e) {
                        return decreaseQuantityHandler(order.id, order.price, "decrease");
                    },
                    id: "dish__quantity-decrease",
                    className: "dish__quantity-decrease " + (qty > 0 ? '' : 'disabled') },
                "\u2013"
            ),
            _react2.default.createElement(
                "button",
                { onClick: function onClick(e) {
                        return increaseQuantityHandler(order.id, order.price, "increase");
                    },
                    id: "dish__quantity-increase",
                    className: "dish__quantity-increase" },
                "+"
            ),
            _react2.default.createElement(
                "div",
                { id: "dish__quantity-details",
...
/***/ "./src/components/basket/BasketWidget.js":
/*!***********************************************!*\
  !*** ./src/components/basket/BasketWidget.js ***!
  \***********************************************/
/*! no static exports found */
...
var Basket = function (_React$Component) {
    ...
    _createClass(Basket, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { id: 'basket', className: 'basket' },
                _react2.default.createElement(
                    _reactRouterDom.Link,
                    { to: '/basket' },
                    _react2.default.createElement(
                        'div',
                        { className: "basket__checkout " + (this.props.basketCount > 0 ? '' : 'hidden') },
                        'Basket (\xA3',
                        this.props.orderAmount.toFixed(2),
                        ')'
                    ),
                    _react2.default.createElement(
                        'div',
...
function Dish(props) {
    ...
    return _react2.default.createElement(
        "div",
        { className: "dish" },
        _react2.default.createElement("div", { className: "dish__image", style: { backgroundImage: "url(" + image + ")" } }),
        _react2.default.createElement(
            "div",
            { className: "dish__details" },
            _react2.default.createElement(
            ...
            _react2.default.createElement(
                "button",
                { onClick: function onClick(e) {
                        return decreaseQuantityHandler(id, price, "decrease");
                    },
                    id: "dish__quantity-decrease",
                    className: "dish__quantity-decrease " + (quantity > 0 ? '' : 'disabled') },
                "\u2013"
            ),
            _react2.default.createElement(
                "button",
                { onClick: function onClick(e) {
                        return increaseQuantityHandler(id, price, "increase");
                    },
                    id: "dish__quantity-increase",
                    className: "dish__quantity-increase" },
                "+"
...
var _Dish = __webpack_require__(/*! ./Dish */ "./src/components/menu/Dish.js");
...
function Menu(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { id: 'menu-container', className: 'menu-container' },
            Object.keys(props.menu).map(function (dishKey) {
                var _props$menu$dishKey = props.menu[dishKey],
                    id = _props$menu$dishKey.id,
                    name = _props$menu$dishKey.name,
                    price = _props$menu$dishKey.price,
                    image = _props$menu$dishKey.image,
                    ingredients = _props$menu$dishKey.ingredients;


                var currentOrder = Object.values(props.orders).find(function (order) {
                    return order.dishId === parseInt(dishKey, 10);
                });

                var quantity = currentOrder ? currentOrder.qty : 0;
...
/***/ "./src/components/navs/SubNavigation.js":
/*!**********************************************!*\
  !*** ./src/components/navs/SubNavigation.js ***!
  \**********************************************/
/*! no static exports found */
...
function BasketNavigation(props) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'basket__options' },
        _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/menu' },
            _react2.default.createElement(
                'h5',
                { className: 'menu__back-to-menu' },
                'Back to Menu'
            )
        ),
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'h5',
                { onClick: oldOrdersHandler, className: 'menu__back-to-menu' },
                'Order History'
            )
        )
    );
}
exports.default = BasketNavigation;

/***/ }),

/***/ "./src/components/orders/OldOrder.js":
/*!*******************************************!*\
  !*** ./src/components/orders/OldOrder.js ***!
  \*******************************************/
/*! no static exports found */
...
function OldOrder(props) {
    ...
    var reorderHandler = function reorderHandler() {
        var date = new Date();
        var minutes = date.getMinutes() < 10 ? '0' + date.getMinutes() : '' + date.getMinutes();
        var seconds = date.getSeconds() < 10 ? '0' + date.getSeconds() : '' + date.getSeconds();
        var orderDate = date.toDateString() + ", " + date.getHours() + ":" + minutes + ":" + seconds;
    ...
    var deleteOldOrderHandler = function deleteOldOrderHandler(id) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'old-order__products' },
            _react2.default.createElement(
                'ul',
                null,
                products.map(function (product) {
                    return Object.keys(product).map(function (item) {
                        return _react2.default.createElement(
                            'li',
                            { key: menu[item].name },
                            _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'strong',
                null,
                totalAmount.toLocaleString('en-gb', { style: 'currency', currency: 'GBP' })
            )
        ),
        _react2.default.createElement(
            'div',
            { className: 'old-order__re-order-wrapper' },
            _react2.default.createElement(
                'button',
                {
                    onClick: function onClick() {
                        return reorderHandler(order);
                    },
                    className: 'old-order__re-order' },
                'Re-order'
            ),
            _react2.default.createElement(
                'button',
                {
                    onClick: function onClick() {
                        return deleteOldOrderHandler(order);
                    },
                    className: 'old-order__delete' },
                'Delete'
            )
        )
    );
...
exports.default = OldOrder;

/***/ }),

/***/ "./src/components/orders/OldOrders.js":
/*!********************************************!*\
  !*** ./src/components/orders/OldOrders.js ***!
  \********************************************/
/*! no static exports found */
...
var _OldOrder = __webpack_require__(/*! ./OldOrder */ "./src/components/orders/OldOrder.js");

var _OldOrder2 = _interopRequireDefault(_OldOrder);
...
function OldOrders(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: "old-orders__empty " + (Object.keys(props.oldOrders).length > 0 ? "hidden" : "") },
            'No order history'
        ),
        Object.keys(props.oldOrders).map(function (order) {
            return _react2.default.createElement(_OldOrder2.default, {
